...
namespace AnkyMod.Survivors.Anky.SkillStates
{
    public class Pump : AnkySkill
    {
        ...
        public override void OnEnter()
        {
            ...
            characterBody.AddTimedBuff(AnkyBuffs.slowBuff, duration);
            if (improved)
            {
                characterBody.AddTimedBuff(AnkyBuffs.damageBuff, duration);
                duration = 5f;
            }
        ...
        private void Fire()
        {
            ...
            foreach (HurtBox hurtbox in HurtBoxes)
            {
                ...
                damageInfo.damage = this.damageStat * AnkyStaticValues.pumpDamageCoefficient + (AnkyStaticValues.pumpHealthDamageCoefficient * GetBonusHealth(characterBody));
