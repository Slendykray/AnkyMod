...
namespace AnkyMod.Survivors.Anky.SkillStates
{
    public class Roar : BaseState
    {
        ...
        public static int maxAttacks = 5;
        ...
        public override void OnEnter()
        {
            ...
            this.overlapAttack = base.InitMeleeOverlap(AnkyStaticValues.roarDamageCoefficient, AnkyAssets.swordHitImpactEffect, base.GetModelTransform(), "RoarGroup");
